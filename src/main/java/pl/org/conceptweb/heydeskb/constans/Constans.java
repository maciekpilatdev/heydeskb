...
public static String GET_AVAILABLE_DESK_IN_PERIOD_SUCCESS_MESSAGE = "lista dostępnych biurek spełniających pryteria"; //"list of available desks in given period";
